...
<br>Copyright (c) 2020 Lorenzo Balducci 
                    ...
                    <div id="tilesSelectorBar" style="text-align: center;">
                        ...
                        <div id="innerMenu" style="visibility: hidden;">
                            ...
                            <div id="elementsMenu7" setName="league of infamy" style="display:none">
                                ...
                                <button class="innerMenuButton" style="width:90%;" id="loadLoiElficKingdom" onclick="loadElementsGroup('loiElficKingdom', this)">Elfic Kingdom</button>
                            </div>
    ...
    <image src="assets/tiles/qrnFurnitures/door-large-Lock-red.png" set="qrnFurnitures" image="door-large-Lock-red" orientation="0" onMapZIndex="2" flippable="no" single="no" pieceType="tile" snap="yes" oncontextmenu="return false;" id="door-large-Lock-red_1" style="position: absolute; cursor: move; width: 100%;" onMap="no"></image>
    <image src="assets/tiles/qrnFurnitures/door-large-Lock-yellow.png" set="qrnFurnitures" image="door-large-Lock-yellow" orientation="0" onMapZIndex="2" flippable="no" single="no" pieceType="tile" snap="yes" oncontextmenu="return false;" id="door-large-Lock-yellow_1" style="position: absolute; cursor: move; width: 100%;" onMap="no"></image>
    <image src="assets/tiles/qrnFurnitures/door-Petit-Lock-red.png" set="qrnFurnitures" image="door-Petit-Lock-red" orientation="0" onMapZIndex="2" flippable="no" single="no" pieceType="tile" snap="yes" oncontextmenu="return false;" id="door-Petit-Lock-red_1" style="position: absolute; cursor: move; width: 100%;" onMap="no"></image>
    <image src="assets/tiles/qrnFurnitures/door-Petit-Lock-Violet.png" set="qrnFurnitures" image="door-Petit-Lock-Violet" orientation="0" onMapZIndex="2" flippable="no" single="no" pieceType="tile" snap="yes" oncontextmenu="return false;" id="door-Petit-Lock-Violet_1" style="position: absolute; cursor: move; width: 100%;" onMap="no"></image>
    <image src="assets/tiles/qrnFurnitures/door-Petit-Lock-yellow.png" set="qrnFurnitures" image="door-Petit-Lock-yellow" orientation="0" onMapZIndex="2" flippable="no" single="no" pieceType="tile" snap="yes" oncontextmenu="return false;" id="door-Petit-Lock-yellow_1" style="position: absolute; cursor: move; width: 100%;" onMap="no"></image>
...
<image src="assets/tiles/faBosses/FA-Boss-Watchmen-Succubs02.png" set="faBosses" image="FA-Boss-Watchmen-Succubs02" flippable="no" orientation="0" onMapZIndex="2" single="yes"pieceType="tile" snap="no" oncontextmenu="return false;" id="FA-Boss-Watchmen-Succubs02"style="position: absolute; cursor: move; width: 100%;" onMap="no"></image>
    ...
    <image src="assets/tiles/loiHeroes/LoiV-hero-warrior-Vampire.png" set="loiHeroes" image="LoiV-hero-warrior-Vampire" flippable="no" orientation="0" onMapZIndex="2" single="yes"pieceType="tile" snap="no" oncontextmenu="return false;" id="LoiV-hero-warrior-Vampire"style="position: absolute; cursor: move; width: 100%;" onMap="no"></image>
                    ...
                    <div class="sidenav" id="loiElficKingdom" style="visibility: hidden;">
    <image src="assets/tiles/loiElficKingdom/LoiE-Boss-cavern-dwellern.png" set="loiElficKingdom" image="LoiE-Boss-cavern-dwellern" flippable="no" orientation="0" onMapZIndex="2" single="yes"pieceType="tile" snap="no" oncontextmenu="return false;" id="LoiE-Boss-cavern-dwellern"style="position: absolute; cursor: move; width: 100%;" onMap="no"></image>
    <image src="assets/tiles/loiElficKingdom/LoiE-Boss-Drakon.png" set="loiElficKingdom" image="LoiE-Boss-Drakon" flippable="no" orientation="0" onMapZIndex="2" single="yes"pieceType="tile" snap="no" oncontextmenu="return false;" id="LoiE-Boss-Drakon"style="position: absolute; cursor: move; width: 100%;" onMap="no"></image>
    <image src="assets/tiles/loiElficKingdom/LoiE-Boss-Elfic-battlecat.png" set="loiElficKingdom" image="LoiE-Boss-Elfic-battlecat" flippable="no" orientation="0" onMapZIndex="2" single="yes"pieceType="tile" snap="no" oncontextmenu="return false;" id="LoiE-Boss-Elfic-battlecat"style="position: absolute; cursor: move; width: 100%;" onMap="no"></image>
    <image src="assets/tiles/loiElficKingdom/LoiE-Boss-Elve-lord-on-Drakon.png" set="loiElficKingdom" image="LoiE-Boss-Elve-lord-on-Drakon" flippable="no" orientation="0" onMapZIndex="2" single="yes"pieceType="tile" snap="no" oncontextmenu="return false;" id="LoiE-Boss-Elve-lord-on-Drakon"style="position: absolute; cursor: move; width: 100%;" onMap="no"></image>
    <image src="assets/tiles/loiElficKingdom/LoiE-Boss-hunter-Drakon.png" set="loiElficKingdom" image="LoiE-Boss-hunter-Drakon" flippable="no" orientation="0" onMapZIndex="2" single="yes"pieceType="tile" snap="no" oncontextmenu="return false;" id="LoiE-Boss-hunter-Drakon"style="position: absolute; cursor: move; width: 100%;" onMap="no"></image>
    <image src="assets/tiles/loiElficKingdom/LoiE-Boss-masterhunter-elve.png" set="loiElficKingdom" image="LoiE-Boss-masterhunter-elve" flippable="no" orientation="0" onMapZIndex="2" single="yes"pieceType="tile" snap="no" oncontextmenu="return false;" id="LoiE-Boss-masterhunter-elve"style="position: absolute; cursor: move; width: 100%;" onMap="no"></image>
    <image src="assets/tiles/loiElficKingdom/LoiE-bowman-elve.png" set="loiElficKingdom" image="LoiE-bowman-elve" flippable="no" orientation="0" onMapZIndex="2" single="yes"pieceType="tile" snap="no" oncontextmenu="return false;" id="LoiE-bowman-elve"style="position: absolute; cursor: move; width: 100%;" onMap="no"></image>
    <image src="assets/tiles/loiElficKingdom/LoiE-Drakon.png" set="loiElficKingdom" image="LoiE-Drakon" flippable="no" orientation="0" onMapZIndex="2" single="yes"pieceType="tile" snap="no" oncontextmenu="return false;" id="LoiE-Drakon"style="position: absolute; cursor: move; width: 100%;" onMap="no"></image>
    <image src="assets/tiles/loiElficKingdom/LoiE-Drakonnet.png" set="loiElficKingdom" image="LoiE-Drakonnet" flippable="no" orientation="0" onMapZIndex="2" single="yes"pieceType="tile" snap="no" oncontextmenu="return false;" id="LoiE-Drakonnet"style="position: absolute; cursor: move; width: 100%;" onMap="no"></image>
    <image src="assets/tiles/loiElficKingdom/LoiE-Elfic-battlecat.png" set="loiElficKingdom" image="LoiE-Elfic-battlecat" flippable="no" orientation="0" onMapZIndex="2" single="yes"pieceType="tile" snap="no" oncontextmenu="return false;" id="LoiE-Elfic-battlecat"style="position: absolute; cursor: move; width: 100%;" onMap="no"></image>
    <image src="assets/tiles/loiElficKingdom/LoiE-Elfic-cat.png" set="loiElficKingdom" image="LoiE-Elfic-cat" flippable="no" orientation="0" onMapZIndex="2" single="yes"pieceType="tile" snap="no" oncontextmenu="return false;" id="LoiE-Elfic-cat"style="position: absolute; cursor: move; width: 100%;" onMap="no"></image>
    <image src="assets/tiles/loiElficKingdom/LoiE-elve-lord-on-drakon.png" set="loiElficKingdom" image="LoiE-elve-lord-on-drakon" flippable="no" orientation="0" onMapZIndex="2" single="yes"pieceType="tile" snap="no" oncontextmenu="return false;" id="LoiE-elve-lord-on-drakon"style="position: absolute; cursor: move; width: 100%;" onMap="no"></image>
    <image src="assets/tiles/loiElficKingdom/LoiE-Harceleur-Sylvanien.png" set="loiElficKingdom" image="LoiE-Harceleur-Sylvanien" flippable="no" orientation="0" onMapZIndex="2" single="yes"pieceType="tile" snap="no" oncontextmenu="return false;" id="LoiE-Harceleur-Sylvanien"style="position: absolute; cursor: move; width: 100%;" onMap="no"></image>
    <image src="assets/tiles/loiElficKingdom/LoiE-hero-hunter-Drakon.png" set="loiElficKingdom" image="LoiE-hero-hunter-Drakon" flippable="no" orientation="0" onMapZIndex="2" single="yes"pieceType="tile" snap="no" oncontextmenu="return false;" id="LoiE-hero-hunter-Drakon"style="position: absolute; cursor: move; width: 100%;" onMap="no"></image>
    <image src="assets/tiles/loiElficKingdom/LoiE-hero-masterhunter-elve.png" set="loiElficKingdom" image="LoiE-hero-masterhunter-elve" flippable="no" orientation="0" onMapZIndex="2" single="yes"pieceType="tile" snap="no" oncontextmenu="return false;" id="LoiE-hero-masterhunter-elve"style="position: absolute; cursor: move; width: 100%;" onMap="no"></image>
    <image src="assets/tiles/loiElficKingdom/LoiE-hunter-Drakon.png" set="loiElficKingdom" image="LoiE-hunter-Drakon" flippable="no" orientation="0" onMapZIndex="2" single="yes"pieceType="tile" snap="no" oncontextmenu="return false;" id="LoiE-hunter-Drakon"style="position: absolute; cursor: move; width: 100%;" onMap="no"></image>
    <image src="assets/tiles/loiElficKingdom/LoiE-masterhunter-elve.png" set="loiElficKingdom" image="LoiE-masterhunter-elve" flippable="no" orientation="0" onMapZIndex="2" single="yes"pieceType="tile" snap="no" oncontextmenu="return false;" id="LoiE-masterhunter-elve"style="position: absolute; cursor: move; width: 100%;" onMap="no"></image>
    <image src="assets/tiles/loiElficKingdom/LoiE-spearman-elve.png" set="loiElficKingdom" image="LoiE-spearman-elve" flippable="no" orientation="0" onMapZIndex="2" single="yes"pieceType="tile" snap="no" oncontextmenu="return false;" id="LoiE-spearman-elve"style="position: absolute; cursor: move; width: 100%;" onMap="no"></image>
    <image src="assets/tiles/loiElficKingdom/LoiE-trainer-de-Drakon.png" set="loiElficKingdom" image="LoiE-trainer-de-Drakon" flippable="no" orientation="0" onMapZIndex="2" single="yes"pieceType="tile" snap="no" oncontextmenu="return false;" id="LoiE-trainer-de-Drakon"style="position: absolute; cursor: move; width: 100%;" onMap="no"></image>
    <image src="assets/tiles/loiElficKingdom/starting-position-Elf-kingdom.png" set="loiElficKingdom" image="starting-position-Elf-kingdom" flippable="no" orientation="0" onMapZIndex="2" single="no"pieceType="tile" snap="yes" oncontextmenu="return false;" id="starting-position-Elf-kingdom_1"style="position: absolute; cursor: move; width: 100%;" onMap="no"></image>
                    </div>
